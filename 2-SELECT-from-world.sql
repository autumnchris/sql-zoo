-- 1. Observe the result of running the SQL command to show the name, continent, and population of all countries.
...
-- 11. Show the name and capital where the name and the capital have the same number of characters. You can use the LENGTH function to find the number of characters in a string.
